...
if(Mobile.verifyElementNotExist(findTestObject('Object Repository/GC_VerifyGalaxyClub/android.widget.TextView - Galaxy Club'), 0 , FailureHandling.STOP_ON_FAILURE))
{
	Mobile.tap(findTestObject('Object Repository/GC_VerifyGalaxyClub/android.widget.ImageView (2)'), 0)
